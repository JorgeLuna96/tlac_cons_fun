<div class="pagina">
    ...
    <div style="padding-left: 55px">
        ...
        <div style="padding-top: 10px">
            <table class="info cuerpo">
                <tr class=" grow info">
                    ...
                    <td style="width: 23%; color: black; font-weight: bold; padding: 10px 5px; position: absolute; 
                    top: auto; left: 67%; right: 0; bottom: 63%; border: 1px solid black; text-align: justify; margin-right: 10px">
        ...
        <div style="padding-top: 20px;">
            <table class="info cuerpo" style="text-align: center;">
                <tr class="info">
                    ...
                    <td style="width: 5%"></td>
                    <td style="border: 1px solid black; width: 5%; white-space:nowrap; text-justify: center;">
                        <div style="padding: 0 5px; color: #214465; display: block">
        ...
        <div style="padding-top: 10px">
            <div style="position: absolute; top: auto; left:8.5%; right: 0; bottom: 16.5%;">
                <div class="firma" style="width: 35%"></div>
            </div>
            <div style="position: absolute; top: auto; left: 49%; right: 0; bottom: 16.5%;">
